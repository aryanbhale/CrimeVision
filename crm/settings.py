...
ALLOWED_HOSTS = ['sheltered-stream-64198.herokuapp.com', '127.0.0.1', 'localhost', 'LOCALHOST']
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'aryanbhale2004@gmail.com'
EMAIL_HOST_PASSWORD = 'hctmvlamlcmjwtze'
